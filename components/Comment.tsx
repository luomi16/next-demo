  ...
  return (
        <div key={id} className="mb-4 p-6">
          ...
          <p className="flex items-start space-x-2">
            ...
            <span className="bg-[#B1CDCB] text-gray-700 text-base p-1 inline-block leading-tight">
              {quote}
            </span>
          </p>
          <div className="text-[#11151C] text-sm my-2 p-1">
            {content}
          </div>
          ...
          <div className="flex justify-between">
            <div className="flex">
              ...
              <div className="mx-2 mb-2 mr-6 text-[#9F9F9F]">
                {likeNum}
              </div>
              <svg
                width="18"
